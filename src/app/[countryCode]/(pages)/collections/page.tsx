...
export async function generateMetadata(props: Props): Promise<Metadata> {
  try {
    ...
    return {
      title: "Koleksiyonlar ",
      description:
        "Tüm koleksiyonlarımızı keşfedin ve favori ürünlerinizi bulun",
      openGraph: {
        title: "Koleksiyonlar ",
        description:
          "Tüm koleksiyonlarımızı keşfedin ve favori ürünlerinizi bulun",
    ...
    console.error("Error generating metadata for collections:", error);
    return {
      title: "Koleksiyonlar ",
      description: "Tüm koleksiyonlarımızı keşfedin",
    };
  ...
  try {
    ...
    return (
      <>
        {/* Breadcrumb Section */}
        <section>
          <Breadcrumb title="Koleksiyonlar" pages={["Koleksiyonlar"]} />
        </section>
            ...
            <div className="py-8">
              ...
              <div className="mb-7 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">
                    Özel olarak seçilmiş ürün koleksiyonlarımızı keşfedin
                  </p>
                </div>
              </div>
                ...
                <div className="text-center py-12">
                  <div className="max-w-md mx-auto">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Henüz hiç koleksiyon bulunmuyor.
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-gray-600">
                  {collections.length} koleksiyon gösteriliyor
                </p>
              </div>
            </div>
          </div>
