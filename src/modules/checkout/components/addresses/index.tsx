        ...
        <div>
          <div className="text-small-regular">
            {cart && cart.shipping_address ? (
              <div className="flex flex-col lg:flex-row items-start gap-x-8 gap-y-4">
                <div className="flex flex-col lg:flex-row items-start gap-x-1 w-full gap-y-4 lg:gap-y-0">
                  <div
