    ...
    <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
      ...
      {isRefreshing && (
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-600">Güncelleniyor...</span>
        </div>
      )}
      ...
      <button
        ...
        className="ml-auto text-xs text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        Şimdi Güncelle
      </button>
    </div>
