        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href={`tel:${phone}`} className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col sm:flex-row lg:flex-col lg:items-end gap-3">
              <li className="w-full sm:w-1/2 lg:w-full">
                <a
                  className="inline-flex w-full items-center gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-dark ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
                  ...
                  <div>
                    <span className="block text-custom-xs">İndir</span>
              ...
              <li className="w-full sm:w-1/2 lg:w-full">
                <a
                  className="inline-flex w-full items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-blue ease-out duration-200 hover:bg-opacity-95"
                  href="#"
                >
                  <svg
                    className="fill-current"
