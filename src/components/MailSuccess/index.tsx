...
const MailSuccess = () => {
  return (
    <>
      <Breadcrumb title={"E-posta Başarılı"} pages={["E-posta Başarılı"]} />
          ...
          <div className="bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25">
            <div className="text-center">
              ...
              <p className="max-w-[491px] w-full mx-auto mb-7.5">
                Mesajınız için çok teşekkür ederiz. E-postaları sık sık kontrol
                ediyoruz ve sorularınıza yanıt vermek için elimizden geleni
                yapacağız.
              </p>
