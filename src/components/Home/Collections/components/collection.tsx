    ...
    <div className="max-w-[1170px]  w-full mx-auto px-4 sm:px-8 xl:px-0">
      ...
      <div className="mb-7 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex-1">
          <span className="flex items-center gap-2 font-medium text-xs sm:text-sm text-dark mb-2">
            <svg
              width="16"
              height="16"
              viewBox="0 0 20 20"
            ...
            <span className="hidden sm:inline">
              En çok satılan altın ve gümüş ürünlerimizi inceleyin
            </span>
            <span className="sm:hidden">En çok satılan ürünler</span>
          </span>
        ...
        <LocalizedClientLink
          ...
          className="inline-flex font-medium text-xs sm:text-custom-sm py-2 sm:py-2.5 px-4 sm:px-7 rounded-md border-gray-3 border bg-gray-1 text-dark ease-out duration-200 hover:bg-dark hover:text-white hover:border-transparent flex-shrink-0"
        >
          Tümünü Gör
        </LocalizedClientLink>
      </div>
